...
public class ContentsProc implements ContentsProcInter {
  ...
  public List<ContentsVO> list_by_genreno(int genreno) {
    List<ContentsVO> list=this.contentsDAO.list_by_genreno(genreno);
    return list;
  }
  ...
  public List<ContentsVO> list_by_genreno_search(HashMap<String, Object> hashMap) {
    List<ContentsVO> list = contentsDAO.list_by_genreno_search(hashMap);
    return list;
  }
  
  @Override
  public List<ContentsVO> total_search(HashMap<String, Object> hashMap) {
    List<ContentsVO> list = contentsDAO.total_search(hashMap);
    return list;
  }
  ...
  public int total_search_count(HashMap<String, Object> hashMap) {
    int count = contentsDAO.total_search_count(hashMap);
    return count;
  }
  ...
  public List<ContentsVO> list_by_genreno_search_paging(HashMap<String, Object> map) {
    ...
    */
    ...
    List<ContentsVO> list = this.contentsDAO.list_by_genreno_search_paging(map);
