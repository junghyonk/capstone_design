...
<jsp:include page="/menu/top.jsp" />
    ...
    <c:forEach var="questionVO" items="${list }">  <!-- request 객체에 접근 -->
      ...
      <TR>
         ...
         <TD class="td_bs">
          <A href="javascript:update_form(${questionno })"><span class="glyphicon glyphicon-pencil"></span></A>
          <A href="javascript:delete_form(${questionno })"><span class="glyphicon glyphicon-trash"></span></A>
        </TD>
        </c:forEach>
          </tbody>
